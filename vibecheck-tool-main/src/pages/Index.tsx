...
import { Crown, TrendingUp, Star, Mail, Phone, Clock, Send } from "lucide-react";
...
const CONTACT_INFO = [
  { icon: Mail,  label: "Email",   value: "hello@artevia.io" },
  { icon: Phone, label: "Phone",   value: "+91 98200 47381" },
  { icon: Clock, label: "Support", value: "Mon–Fri, 9:30 AM – 6:30 PM IST" },
];
...
const ContactSection = () => {
  ...
  const inputClass =
    "w-full border-[1.5px] border-foreground/[0.18] rounded-lg px-4 py-3 bg-background/30 " +
    "text-foreground placeholder:text-muted-foreground/50 focus:border-primary " +
    "focus:ring-2 focus:ring-primary/15 outline-none transition font-body text-sm";
  ...
  return (
    <section className="py-16 lg:py-24">
      <div className="container mx-auto px-6">
        {/* Header */}
        <div className="text-center mb-12">
          <div className="hero-eyebrow mb-3">Get In Touch</div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          <div className="flex flex-col justify-center space-y-6">
            {CONTACT_INFO.map(({ icon: Icon, label, value }) => (
              <div key={label} className="flex items-start gap-4">
                ...
                <div>
                  <div className="text-xs font-bold tracking-widest uppercase text-muted-foreground/60 mb-0.5">
                    {label}
                  </div>
            ...
            <div className="pt-4">
              <p className="text-sm text-muted-foreground leading-relaxed">
                For detailed enquiries, visit our{" "}
          ...
          <div className="bg-card rounded-3xl p-8 shadow-md border border-primary/[0.08]">
            <h3 className="font-display text-xl text-foreground mb-1">Send a Quick Message</h3>
            <p className="text-xs text-muted-foreground mb-6">We typically reply within 24 hours.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={sending}
                className="btn-accent w-full py-3.5 flex items-center justify-center gap-2 disabled:opacity-60"
              >
                <Send size={15} />
