...
export const ThemeModeProvider = ({ children }: { children: ReactNode }) => {
  ...
  // Toggle the class on the root element to avoid an extra wrapper div
  useEffect(() => {
    document.documentElement.classList.toggle("luxe-theme", applyLuxe);
    return () => document.documentElement.classList.remove("luxe-theme");
  }, [applyLuxe]);
